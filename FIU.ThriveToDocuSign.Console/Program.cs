        ...
        public static void Main(string[] args)
        {
            ...
            catch (ApiException apiExp)
            {
                ...
                if (apiExp.Message.Contains("consent_required"))
                {
                    ...
                    string url = "https://" + AUTH_SERVER + "/oauth/auth?response_type=code" + caret + "&scope=impersonation%20signature" + caret +
                        "&client_id=" + CLIENT_ID + caret + "&redirect_uri=" + DevCenterPage;
            ...
            docuSignClient.SetOAuthBasePath(AUTH_SERVER);
            ...
            string signerEmail = "tanviranik@gmail.com";
            System.Console.Write("Enter the signer's name: ");
            string signerName = "Tanvir";
            System.Console.Write("Enter the carbon copy's email address: ");
            string ccEmail = "alamanik@ualberta.ca";
            System.Console.Write("Enter the carbon copy's name: ");
            string ccName = "Alam Anik";
            string docDocx = @"..\..\..\Documents\World_Wide_Corp_lorem.docx";
            //string docPdf = Path.Combine("..", "..", "..", "Documents", "World_Wide_Corp_lorem.pdf");
            string docPdf = @"..\..\..\Documents\World_Wide_Corp_lorem.pdf";
